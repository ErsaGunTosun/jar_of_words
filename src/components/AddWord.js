...
function AddWord({ status, handleWordModal, AddWordData }) {
    ...
    return (
        <>
            ...
            <div id="popup-modal" tabIndex="-1" className={`${status ? "" : "hidden"} bg-neutral-100/25 h-full justify-center items-center flex fixed top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full`}>
                    ...
                    <div className="relative bg-neutral-900 rounded-lg">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <div>
                                ...
                                <div className="relative z-0 w-full mb-6 group text-start">
                                    <input value={meaning} onChange={(e) => setMeaning(e.target.value)} type="email" name="meaning" id="meaning" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required />
                                ...
                                <div className="relative z-0 w-full mb-6 group text-start">
                                    <input value={sentence} onChange={(e) => setSentence(e.target.value)} type="email" name="sentence" id="sentence" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required />
